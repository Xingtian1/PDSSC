...
OUTFILE="$LOG_DIR/controller_train_2gpu.log"
PIDFILE="$LOG_DIR/controller_train_2gpu.pid"
...
torchrun --standalone --nproc_per_node="$NPROC_PER_NODE" scripts/train_controller.py --flow_ckpt /home/chenghao/SpeechTokenizer-main/output/flow_checkpoints_stage3/best_train.pt --data_dir /home/chenghao/SpeechTokenizer-main/LibriSpeech --save_dir /home/chenghao/SpeechTokenizer-main/output/controller_checkpoints --batch_size "$PER_GPU_BATCH_SIZE" --num_workers "$NUM_WORKERS" --segment_sec "$SEGMENT_SEC" --max_epochs 20 --patience 5 --n_layers_list $N_LAYERS_LIST --r_max_values $R_MAX_VALUES --plr_values $PLR_VALUES --tol_mode "$TOL_MODE" --rel_margin "$REL_MARGIN" --abs_margin "$ABS_MARGIN" --log_every "$LOG_EVERY"
